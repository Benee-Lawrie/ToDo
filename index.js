  ...
  const displayTodo = () => {
    ...
    for (let index = 0; index < taskArray.length; index++) {
      ...
      editBtn.addEventListener("click", ()=>{
        ...
        taskName.value = taskArray[index].nameOfTask;
        taskDescription.value = taskArray[index].taskDescription;
        ...
        button.onclick = function(){
          ...
          taskArray.splice(index , 1, updateTask)
          displayTodo()
          button.onclick =""
          taskName.value= ""
          taskDescription.value=""
